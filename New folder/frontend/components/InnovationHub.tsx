...
import { getFeatureRecommendations } from '../services/innovationService';
...
const ExperienceIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.47a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.63 2.25a14.98 14.98 0 0 0-5.96 12.12c0 3.193.986 6.227 2.75 8.72v-4.8m3.21-4.18a6 6 0 0 1 5.84-7.38v4.8" />
  </svg>
);
